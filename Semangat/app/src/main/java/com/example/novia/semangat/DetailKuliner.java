    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent a = new Intent(DetailKuliner.this,MapsActivity2.class);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()){
                    final ImageUploadInfoWis i = postSnapshot.getValue(ImageUploadInfoWis.class);
...
//                Picasso.with(getApplicationContext()).load(url).into(target1);// aku manggil modelnya error
        ...
        btn_share.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v)
            {
                Intent intent = new Intent(DetailKuliner.this, DisplayWisata.class);
...
//        shareDialog = new ShareDialog(this);
    ...
    public void callTelepon()
    {
        ...
        if (ContextCompat.checkSelfPermission(DetailKuliner.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(DetailKuliner.this, new String[]{android.Manifest.permission.CALL_PHONE},REQUEST_PHONE_CALL);
        }
        else
        {
