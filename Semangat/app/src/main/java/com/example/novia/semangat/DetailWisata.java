    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent a = new Intent(DetailWisata.this,MapsActivity2.class);
...
//                Picasso.with(getApplicationContext()).load(url).into(target1);// aku manggil modelnya error
        ...
        btn_share.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v)
            {
                Intent intent = new Intent(DetailWisata.this, DisplayWisata.class);
...
//        shareDialog = new ShareDialog(this);
    ...
    public void callTelepon()
    {
        ...
        if (ContextCompat.checkSelfPermission(DetailWisata.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(DetailWisata.this, new String[]{android.Manifest.permission.CALL_PHONE},REQUEST_PHONE_CALL);
        }
        else
        {
